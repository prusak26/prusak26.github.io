...
(function () {
	...
	var version_modss = '2.7.3', API = Lampa.Utils.protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = true, user_id = '', uid = '48f030ca59bf0f6b3d91', IP, logged = true;
